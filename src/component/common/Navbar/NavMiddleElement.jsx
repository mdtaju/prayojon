...
const NavMiddleElement = ({ toolTitle, activeLink }) => {
      ...
      if (toolTitle === "Home") {
            if (router.pathname === activeLink) {
                  IconContent = <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.5 13.5L18 3L31.5 13.5V30C31.5 30.7956 31.1839 31.5587 30.6213 32.1213C30.0587 32.6839 29.2956 33 28.5 33H7.5C6.70435 33 5.94129 32.6839 5.37868 32.1213C4.81607 31.5587 4.5 30.7956 4.5 30V13.5Z" stroke="#1979F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M13.5 33V18H22.5V33" stroke="#1979F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
            } else {
                  IconContent = <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.5 13.5L18 3L31.5 13.5V30C31.5 30.7956 31.1839 31.5587 30.6213 32.1213C30.0587 32.6839 29.2956 33 28.5 33H7.5C6.70435 33 5.94129 32.6839 5.37868 32.1213C4.81607 31.5587 4.5 30.7956 4.5 30V13.5Z" stroke="#8190A3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M13.5 33V18H22.5V33" stroke="#8190A3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
            }
      }
      ...
      if (toolTitle === "Cart") {
            if (router.pathname === activeLink) {
                  IconContent = <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6.75 6.75H33.75L30.375 21.375H10.125M30.375 25.875H11.25L5.625 2.25H2.25" stroke="#1979F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M28.125 32.625C29.3676 32.625 30.375 31.6176 30.375 30.375C30.375 29.1324 29.3676 28.125 28.125 28.125C26.8824 28.125 25.875 29.1324 25.875 30.375C25.875 31.6176 26.8824 32.625 28.125 32.625Z" stroke="#1979F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M13.5 32.625C14.7426 32.625 15.75 31.6176 15.75 30.375C15.75 29.1324 14.7426 28.125 13.5 28.125C12.2574 28.125 11.25 29.1324 11.25 30.375C11.25 31.6176 12.2574 32.625 13.5 32.625Z" stroke="#1979F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
            } else {
                  IconContent = <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6.75 6.75H33.75L30.375 21.375H10.125M30.375 25.875H11.25L5.625 2.25H2.25" stroke="#8190A3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M28.125 32.625C29.3676 32.625 30.375 31.6176 30.375 30.375C30.375 29.1324 29.3676 28.125 28.125 28.125C26.8824 28.125 25.875 29.1324 25.875 30.375C25.875 31.6176 26.8824 32.625 28.125 32.625Z" stroke="#8190A3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M13.5 32.625C14.7426 32.625 15.75 31.6176 15.75 30.375C15.75 29.1324 14.7426 28.125 13.5 28.125C12.2574 28.125 11.25 29.1324 11.25 30.375C11.25 31.6176 12.2574 32.625 13.5 32.625Z" stroke="#8190A3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
            }
