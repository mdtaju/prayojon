      ...
      return (
            <div className='flex flex-col gap-1 relative'>
                  {/* vertical line from ..... */}
                  {
                        ...
                        <>
                              <div
                                    className={`absolute left-[17px] top-[42px] w-[1px] bg-gray-200 rounded-b-full`}
                                    style={toggleReply ? { height: '90%' } : { height: '55%' }}
                              ></div>
                        </>
                  }
                  {/* to here ..... */}
                              ...
                              {/* view more comment reply button */}
                              {
                                    !toggleReply ?
                                          ...
                                          <div className='ml-[48px] px-2 flex items-center gap-2 mt-2 relative'>
                                                <div className='absolute bottom-[10px] left-[-31px] w-[30px] h-[50px] border-l border-b border-gray-200 rounded-bl-xl'></div>
                                                <FontAwesomeIcon
                                                      icon={faArrowTurnUp}
