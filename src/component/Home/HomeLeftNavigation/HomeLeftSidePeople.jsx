...
const HomeLeftSidePeople = ({ user = {} }) => {
      ...
      return (
            <div className='flex items-start gap-4 common_shadow p-4 rounded-md'>
                  <Avatar
                        alt="Remy Sharp"
                        src={photo_url}
                  ...
                  <div className='flex items-start justify-between gap-6 flex-1'>
                        ...
                        {
                              isFollow ?
                                    <button onClick={handleUnFollow} className='btn_primary px-2 py-1 bg-transparent border border-primary rounded-full text-primary'>Unfollow</button> :
                                    <button onClick={handleFollower} className='btn_primary px-2 py-1 bg-transparent border border-primary rounded-full text-primary'>Follow</button>
                        }
                  </div>
            </div>
      );
